...
class SelfCleaningTemperatureAlertFunction(val threshold: Double)
    extends KeyedProcessFunction[String, Sensor, (String, Double, Double)] {
  ...
  override def processElement(
      reading: Sensor,
      ctx: KeyedProcessFunction[String, Sensor, (String, Double, Double)]#Context,
  ...
  override def onTimer(
      timestamp: Long,
      ctx: KeyedProcessFunction[String, Sensor, (String, Double, Double)]#OnTimerContext,
      out: Collector[(String, Double, Double)]): Unit = {
