...
class UpdatableTemperatureAlertFunction()
    extends KeyedBroadcastProcessFunction[String, Sensor, ThresholdUpdate, (String, Double, Double)] {
  ...
  override def processBroadcastElement(
      ...
      ctx: KeyedBroadcastProcessFunction[String, Sensor, ThresholdUpdate, (String, Double, Double)]#Context,
  ...
  override def processElement(
      reading: Sensor,
      readOnlyCtx: KeyedBroadcastProcessFunction[String, Sensor, ThresholdUpdate, (String, Double, Double)]#ReadOnlyContext,
      out: Collector[(String, Double, Double)]): Unit = {
